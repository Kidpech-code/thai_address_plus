<p align="center">
  <img src="https://raw.githubusercontent.com/Kidpech-code/thai_address_plus/main/assets/images/1.png" width="31%" alt="Thai address autocomplete search screen" />
  <img src="https://raw.githubusercontent.com/Kidpech-code/thai_address_plus/main/assets/images/2.png" width="31%" alt="Thai address cascading dropdown screen" />
  <img src="https://raw.githubusercontent.com/Kidpech-code/thai_address_plus/main/assets/images/3.png" width="31%" alt="Thai administrative boundary map preview" />
</p>

<p align="center"><strong>Search</strong> • <strong>Dropdown</strong> • <strong>Map Preview</strong></p>
...
ต้องการเรียก API โดยตรงนอก Flutter? นำเข้า Postman collection จาก [docs/geo-api.postman_collection.json](docs/geo-api.postman_collection.json) แล้วตั้งค่า `base_url` เป็น `https://api.kidpech.app` เพื่อเริ่มยิง request ได้ทันที
...
1. Import [docs/geo-api.postman_collection.json](docs/geo-api.postman_collection.json) เข้า Postman
2. ตั้ง collection variable `base_url` เป็น `https://api.kidpech.app`
3. เรียกใช้ Thailand Geographic API ได้ทันทีโดยไม่ต้องมี authentication

Resources เพิ่มเติม:

- API guide: [docs/TH_GEO_API.md](docs/TH_GEO_API.md)
- OpenAPI spec: [docs/geo/swagger.yaml](docs/geo/swagger.yaml) และ [docs/geo/swagger.json](docs/geo/swagger.json)
- Hosted API docs: [api.kidpech.app](https://api.kidpech.app)
...
- Package docs and scorecard: [pub.dev/packages/thai_address_plus](https://pub.dev/packages/thai_address_plus)
- Hosted API docs: [api.kidpech.app](https://api.kidpech.app)
- Postman collection: [docs/geo-api.postman_collection.json](docs/geo-api.postman_collection.json)
- OpenAPI spec: [docs/geo/swagger.yaml](docs/geo/swagger.yaml)
